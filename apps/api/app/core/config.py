...
class Settings(BaseSettings):
    ...
    # Créditos y mora (#F05)
    MORA_RATE: float = 0.03  # 3% mensual sobre capital vencido (NUNCA capitaliza mora)
    CREDIT_MIN_INITIAL_PERCENT: float = 0.20  # inicial mínimo sugerido (solo alerta)
    CREDIT_DEFAULTED_MIN_OVERDUE: int = 2  # cuotas vencidas para marcar DEFAULTED
    MORA_APPLY_HOUR: int = 6  # hora local para la tarea diaria de mora
    RESERVATION_EXPIRY_DAYS: int = 30  # vigencia de reservas por crédito
